...
public class IndexModel : PageModel
{
    ...
    public async Task OnGetAsync()
    {
        using (var client = new HttpClient())
        {
            ...
            var foodResponse = await client.GetAsync("https://dulichquangnamdeploy.onrender.com/api/foods");
            ...
            var tourResponse = await client.GetAsync("https://dulichquangnamdeploy.onrender.com/api/tours");
            ...
            var stayResponse = await client.GetAsync("https://dulichquangnamdeploy.onrender.com/api/stays");
            ...
            var destinationResponse = await client.GetAsync("https://dulichquangnamdeploy.onrender.com/api/destinations");
            ...
            var serviceResponse = await client.GetAsync("https://dulichquangnamdeploy.onrender.com/api/services");
